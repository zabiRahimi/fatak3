...
export default function ShowVerifyMobile() {
    ...
    const handleSubmit = (e) => {
        ...
        axios.post(path, data, { headers: { 'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content'), 'Content-Type': 'application/json; charset=utf-8' } })
            ...
            .catch(error => {
                ...
                errorSubmit(e, error.response.status, error.response.data.errors, element, 'showVerifyMobile');
                    
                }else{
                    errorCodeVerify(e, error.response.status,error.response.data.errors,element, 'showVerifyMobile')
                }
            })
    }
    ...
    return (
        <div className='formContainer'>
            <div className="formRight">
                ...
                <form className='form' id='showVerifyMobile' method='post' onSubmit={handleSubmit}>
                    ...
                    <div className="groupInput">
                        <div className="inputForm " id='divName' data-lang='num' >
                            <div className='divLabel'>
                                ...
                                <label htmlFor="name">کد تایید موبایل</label>
